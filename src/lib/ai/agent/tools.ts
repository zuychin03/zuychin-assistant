            ...
            tasks: {
                ...
                items: {
                    ...
                    properties: {
                        ...
                        model: { type: "string", description: "Optional model hint, such as 'glm-5.3-flash', 'nemotron-3.5-lightning' or 'gemma-4'. Omit to auto-pick a fast free model.", required: false },
                    },
                },
            },
        },
